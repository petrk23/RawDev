...
inline
Color::RGB64 Image::getValue(int row, int col) const
{
...
inline
double Image::getValueR(int row, int col) const
{
	assert(row >= 0 && row < getHeight());
	assert(col >= 0 && col < getWidth());
...
inline
double Image::getValueG(int row, int col) const
{
	assert(row >= 0 && row < getHeight());
	assert(col >= 0 && col < getWidth());
...
inline
double Image::getValueB(int row, int col) const
{
	assert(row >= 0 && row < getHeight());
	assert(col >= 0 && col < getWidth());
...
inline
void Image::setValue(int row, int col, Color::RGB64 value)
{
	assert(row >= 0 && row < getHeight());
	assert(col >= 0 && col < getWidth());
