...
inline Options::Options()
	...
	, m_Tint(0), m_Contrast(25), m_DemosaicIter(3)
	, m_Temperature(5000.0), m_Exposure(0.0)
	, m_NoCrop(false), m_NoProcess(false), m_Verbose(false)
	, m_DemosaicAlg(Demosaic::AlgorithmType::AHD)
	, m_bitDepth(16), m_colorProfile(ColorProfile::sRGB)
{}
