...
{
	int cfaShift; // Inverted CFA shift to next non green filter

	switch (cfa.at(brow, bcol))
	{
...
/// <param name="brow">Tile base row</param>
/// <param name="bcol">Tile base column</param>
/// <param name="himgLab">Horizontally interpolated LAB image</param>
	...
	for (int tr = padding; tr < erow; tr++)
	{
		for (int tc = padding; tc < ecol; tc++)
		{
			...
			else
			{
				...
				value.r = 0.5 * (hval.r + vval.r); // Homogeneity doesn't helped
...
/// <summary>
/// Box 3x3 convolution smoothing of homogeneity for one pixel
/// </summary>
/// <param name="hhomo">Horizontal homogeneity</param>
/// <param name="vhomo">Vertical homogeneity</param>
/// <param name="row">Image row</param>
/// <param name="col">Image column</param>
/// <param name="hhm">Smoothed horizontal homogeneity value</param>
/// <param name="vhm">Smoothed vertical homogeneity value</param>
...
/// <param name="tc">Column inside tiled image</param>
...
{
	Color::CIEXYZ input(cam2XYZ.toXYZ(src));
	Color::CIELab output;
	Color::XYZ2Lab(input, output, Color::D50);
	return output;
}
