...
const Mat3x3 Cam5DsR::k_forwardMat1 = {{
    { 0.5518, 0.2528, 0.1597 },
    { 0.3380, 0.6092, 0.0528 },
    { 0.2019, 0.0004, 0.6229 }
}};
const Mat3x3 Cam5DsR::k_forwardMat2 = {{
...
// Color matrix
const Mat3x3 Cam5DsR::k_colorMat1 = {{
    {  0.6848, -0.1661, -0.0221 },
    { -0.3904,  1.0931,  0.3434 },
    { -0.0470,  0.1251,  0.6039 }
}};
const Mat3x3 Cam5DsR::k_colorMat2 = {{
