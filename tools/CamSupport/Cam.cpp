...
Cam|CAM|::Cam|CAM|(double ctemp)
    : CamProfile(ctemp)
{
    // CFA pattern (if not using the default)
    setCFAPattern(CFAPattern::Filter::GBRG);

    // Change according to used model
